...
parser.add_argument('--model_id', type=str, default="outputs", help='The ID of the base model to load. It will be the path of "outputs" folder.')
...
for i in range(args.num_images):
    ...
    # Save the image
    image.save("generated_base_" + str(i) + ".png")
